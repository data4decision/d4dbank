...
import { FaCheck, FaSearch, FaShareAlt } from 'react-icons/fa';
import { FaArrowRight, FaClock, FaLink, FaMessage, FaPlay, FaShare } from 'react-icons/fa6';
import Slider from "react-slick";
import PaginationLargeImage from "../components/PaginationLargeImage"

const LargeImageComponent = ({darkMode}) => {
  ...
  const News = [
    { id: '/pass.jpg', name: 'Banking', date: 'September 16, 2022', description:"How Non-US Citizens can Open a Bank Account", message:"Don’t just save money, make more money with a checking account from us. – Franklin Every citizens can Open occur that pleasures and when nothing prevents claims of duty obligations of business it will frequently occur our power of choice is untrammelled when othing prevents our being able to do what we like best, every […]", author: "By Admin"},
    { id: '/unity.jpg', name: 'Press Release', date: 'September 16, 2022', description:"Board Approves Capital Raise of Rs. 2000 Crores", message:"Don’t just save money, make more money with a checking account from us. – Franklin Every citizens can Open occur that pleasures and when nothing prevents claims of duty obligations of business it will frequently occur our power of choice is untrammelled when othing prevents our being able to do what we like best, every […]", author: "By Admin"},
    { id: '/reach.jpg', name: 'Finance', date: 'September 16, 2022', description:"The National Avg Interest Rate for Savings Accounts", message:"Don’t just save money, make more money with a checking account from us. – Franklin Every citizens can Open occur that pleasures and when nothing prevents claims of duty obligations of business it will frequently occur our power of choice is untrammelled when othing prevents our being able to do what we like best, every […]", author: "By Admin"  },
    { id: '/vision.jpg', name: 'Banking', date: 'September 16, 2022', description:"Non-US Citizens can Open a Bank Account", message:"Don’t just save money, make more money with a checking account from us. – Franklin Every citizens can Open occur that pleasures and when nothing prevents claims of duty obligations of business it will frequently occur our power of choice is untrammelled when othing prevents our being able to do what we like best, every […]", author: "By Admin"  },
    { id: '/happy.jpg', name: 'Press Release', date: 'September 16, 2022', description:"Small Steps to Build Your Better Future", message:"Don’t just save money, make more money with a checking account from us. – Franklin Every citizens can Open occur that pleasures and when nothing prevents claims of duty obligations of business it will frequently occur our power of choice is untrammelled when othing prevents our being able to do what we like best, every […]", author: "By Admin"  },
    { id: '/bank3.jpg', name: 'Banking', date: 'September 16, 2022', description:"Holds In These Matters To This Principle of Selection", message:"Don’t just save money, make more money with a checking account from us. – Franklin Every citizens can Open occur that pleasures and when nothing prevents claims of duty obligations of business it will frequently occur our power of choice is untrammelled when othing prevents our being able to do what we like best, every […]", author: "By Admin"  },
  ...
  return (
    <div className={`${bankBg} pt-20 pb-20`}>
            <div className="grid grid-cols-1 md:grid-cols-[70%_30%] sm:grid-cols-[70%_30%] w-[85%] m-auto gap-10">
               <div className={`grid grid-cols-1 md:grid-cols-1 sm:grid-cols-1 gap-10 ${border}`}>
                {News.map((News, index)=>(
                    <div key={index} className="relative group  border-1">
                        <a href="">
                            <img  src={(News.id).replace(/\.$/, '')} alt="" className={`w-full h-[450px] object-cover object-top transition-all duration-300 group-hover:grayscale-0  group-hover:black`}  />
                            <span className='className="absolute inset-0 bg-black opacity-0 group-hover:opacity-100 transition-opacity  duration-300 h-[450px]'>
                                <FaArrowRight size={25} className='text-red-500 absolute top-50 left-100 opacity-0 group-hover:opacity-100' />
                            </span>
                           
                        </a>
                        
                        <div className={`flex ${bankBg}  px-4 py-4 gap-4 justify-between absolute top-90 left-5 z-10 w-full shadow-lg`}>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <p className={`${textColor}`}>{News.date}</p>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className={`${primaryBg} w-2 h-2 rounded-full`}></span>
                                <p className={`${textColor}`}>{News.author}</p>
                            </div>
                            </div>
                            <div className="">
                                 <FaShareAlt size={18} className={`${textColor}`}/>
                            </div>
                        </div>
                            ...
                            <div className=" flex flex-col gap-3 px-6 py-6 ">
                                ...
                                <div className="flex items-center justify-between gap-2 mt-5">
                                    <div className="flex items-center gap-2 group">
                                        <FaArrowRight size={18} className={`${textColor} group-hover:text-red-500`}/>
                                        <div className="flex items-center gap-1">
                                            <a href="">
                                                <p className={`${textColor} group-hover:text-red-500`}>Continue Reading</p>
                                            </a>
                                        </div>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex items-center gap-1">
                                                <a href="">
                                                <p className={`${textColor} hover:text-red-500`}>3, 889 Comments</p>
                                            </a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <PaginationLargeImage darkMode={darkMode}/>
        </div>
      )
    }
