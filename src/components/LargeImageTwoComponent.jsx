...
import { FaArrowRight, FaLink, FaMessage, FaPlay } from 'react-icons/fa6';
import Slider from "react-slick";
import PaginationLargeImage from "../components/PaginationLargeImage"

const LargeImageTwoComponent = ({darkMode}) => {
    ...
    <div className={`${bankBg} pt-20 pb-20`}>
            <div className="grid grid-cols-1 md:grid-cols-[70%_30%] sm:grid-cols-[70%_30%] w-[85%] m-auto gap-10">
               <div className={`grid grid-cols-1 md:grid-cols-1 sm:grid-cols-1 gap-10 ${border}`}>
                {News.map((News, index)=>(
                    <div key={index} className="relative groups  border-1">
                        <a href="">
...
export default LargeImageTwoComponent