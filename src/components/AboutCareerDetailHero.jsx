...
const AboutCareerDetailHero = ({ darkMode }) => {
  ...
  return (
    <div className="relative w-full flex justify-center opacity-100 items-center pt-7 pb-7">
      <img
        src="/AboutUs.jpg"
        alt="hero"
        className="w-full max-w-7xl h-[180px] sm:h-[250px] md:h-[400px] object-cover rounded-lg grayscale-95 object-top"
      />
      <span
        className={`
          ...
          rounded-lg shadow-lg w-[50vw] max-w-[320px] sm:max-w-[370px]
        `}
      >
        Career Details
      </span>
...
export default AboutCareerDetailHero;
